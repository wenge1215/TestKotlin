...
import kotlinx.android.synthetic.main.activity_main.*       //使用Kotlin Android Extensions 依赖，省略 查找控件
...
////                rvList.adapter = RvAdapter(forecastList,this@MainActivity)
                ...
                fList.adapter = RvAdapter(forecastList){toast(it.date)}   //相当于 rvList.setAdapter(new RvAdapter(forecastList))
            }
        }
    }
