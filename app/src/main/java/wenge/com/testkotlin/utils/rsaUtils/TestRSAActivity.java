package wenge.com.testkotlin.utils.rsaUtils;
...
public class TestRSAActivity extends Activity implements OnClickListener
{
...
//				byte[] encryptByte = RSAUtils.encryptData(source.getBytes(), publicKey);
                ...
                byte[] encryptByte = RSAUtils.encryptData(source.getBytes(), mAPublic);
...
//				byte[] decryptByte = RSAUtils.decryptData(Base64Utils.decode(encryptContent),
//                        privateKey);

                byte[] decryptByte = RSAUtils.decryptData(Base64Utils.decode(encryptContent), mAPrivate);
